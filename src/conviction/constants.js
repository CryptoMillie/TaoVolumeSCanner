...
// UnlockRate: 60-day half-life = 648,000 blocks (at ~12s/block)
export const UNLOCK_RATE_BLOCKS = 648_000;
...
export const TOOLTIPS = {
  conviction: "Conviction score reflects how long the owner has committed to the subnet. Locking to the owner\u2019s hotkey gives instant conviction. Locking to any other hotkey follows a 60-day maturity curve. Zero conviction with an active lock means the lock just started.",
  lockType: "Perpetual locks keep locked_mass constant and grow conviction toward 100%. Decaying locks lose locked_mass over time with a 60-day half-life \u2014 after 6 months only 12.5% remains. Perpetual is opt-in via set_perpetual_lock.",
